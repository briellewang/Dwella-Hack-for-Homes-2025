...
const PropertyListPage = ({ setCurrentView, setSelectedPropertyId }) => {
  ...
  const handleSwipeDelete = (propertyId) => {
    // Handle swipe delete functionality
        ...
        <div className="w-full max-w-sm bg-white shadow-2xl relative overflow-hidden" style={{ height: "100vh" }}>
          ...
          <div className="bg-white border-b border-gray-200 p-4">
            <div className="flex items-center">
              ...
              <img 
                src={property.agent?.avatar || "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face"} 
                alt={property.agent?.name || "Agent"}
                className="w-10 h-10 rounded-full mr-3 object-cover"
              />
              <div className="flex-1">
                <h2 className="font-semibold text-gray-800">{property.agent?.name || "Property Agent"}</h2>
          ...
          {/* 可滚动的聊天内容 */}
          <div className="p-4 space-y-4 overflow-y-auto pb-20" style={{ height: "calc(100vh - 80px)" }}>
            {/* 系统消息 */}
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <div className="flex items-center space-x-2 flex-shrink-0">
                            ...
                            <span className="text-xs text-gray-400">{property.time || "Now"}</span>
                          </div>
                        </div>
                        ...
                        <p className={`text-sm truncate ${
                          ...
                          {property.lastMessage || "Available for viewing"}
                        </p>
                      </div>
