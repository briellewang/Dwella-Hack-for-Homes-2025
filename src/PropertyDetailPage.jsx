  ...
  return (
    <div className="min-h-screen bg-gray-50 flex justify-center">
      ...
      <div className="w-full max-w-sm bg-white shadow-2xl relative overflow-hidden" style={{ height: "100vh" }}>
        {/* Fixed Header */}
        <div className="fixed top-0 left-1/2 transform -translate-x-1/2 w-full max-w-sm bg-white shadow-sm z-10">
        ...
        <div className="pt-16 pb-24 overflow-y-auto" style={{ height: "100vh" }}>
          {/* Image Gallery */}
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-gray-50 rounded-xl p-4">
              <h3 className="text-lg font-semibold text-gray-800 mb-3">Landlord</h3>
        ...
        <div className="fixed bottom-0 left-1/2 transform -translate-x-1/2 w-full max-w-sm bg-white border-t border-gray-200 p-4 z-10">
